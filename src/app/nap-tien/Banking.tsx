...
export default function Banking({ banking = [], user }: { banking: any[]; user: any }) {
                                ...
                                <table className="table table-row-dashed table-row-gray-300 gy-7">
                                    <tbody>
                                        <tr>
                                            <td>Ngân Hàng</td>
                                            <td>
                                                <p className="text-danger fw-bold bank-name" style={{ cursor: "pointer" }}>
                                                    {bank.bank_name}
                                                </p>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <p className="text-black fw-bold account-owner" style={{ cursor: "pointer" }}>
                                                    {bank.account_name}
                                                </p>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>Số tài khoản</td>
                                            <td>
                                                <p className="text-black fw-bold account-number" style={{
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <p className="text-black fw-bold content-tranfer" style={{
                                                    cursor: "pointer", display: "inline-block",
                                                }}>
                                                    lsv {user.username}
                                                </p>
                                        ...
                                        <tr>
                                            <td>Nạp ít nhất</td>
                                            <td>
                                                <p className=" fw-bold amount-money" style={{ cursor: "pointer" }}>
                                                    {bank?.min_recharge
